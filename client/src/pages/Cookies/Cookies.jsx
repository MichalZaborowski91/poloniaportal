        ...
        <div className={styles.card}>
          <section id="general">
            ...
            <p>
              ...
              Regulaminu Serwisu oraz Polityki Prywatności i określa informacje
              dotyczące sposobu wykorzystywania plików cookies podczas
            ...
            <p>
              ...
              przez podmioty trzecie, jeżeli jest to związane z funkcjonowaniem
              lub rozwojem poszczególnych funkcjonalności Serwisu.
            </p>
          </section>
          <section id="whatAreCookies">
            ...
            <p>
              ...
              zapamiętanie określonych informacji, takich jak wybrane ustawienia
            ...
            <p>
              <strong>2.5.</strong> Nie wszystkie pliki cookies są niezbędne do
              korzystania z Serwisu. W przypadku cookies, których stosowanie
              wymaga zgody użytkownika, odpowiednie technologie są uruchamiane
              zgodnie z dokonanymi przez użytkownika wyborami oraz
          ...
          <section id="types">
            ...
            <p>
              ...
              sposobu działania oraz podmiotu, który je umieszcza na urządzeniu
              użytkownika.
            </p>
            ...
            <p>
              <strong>3.3.</strong> Cookies sesyjne są przechowywane przez okres
              trwania sesji użytkownika i mogą zostać usunięte po zamknięciu
              przeglądarki lub zakończeniu sesji, zależnie od sposobu ich
              działania.
            </p>
            ...
            <p>
              <strong>3.5.</strong> Ze względu na podmiot, który umieszcza pliki
              cookies, mogą być wykorzystywane cookies własne, umieszczane
              bezpośrednio przez PoloniaPortal, oraz cookies podmiotów trzecich,
              związane z usługami zewnętrznych dostawców wykorzystywanymi w
              Serwisie.
            </p>
          ...
          <section id="necessary">
            ...
            <p>
              <strong>4.1.</strong> Niezbędne pliki cookies są wykorzystywane w
              zakresie koniecznym do prawidłowego działania Serwisu oraz
            ...
            <p>
              ...
              bez zgody użytkownika, jeżeli ich wykorzystanie jest konieczne do
              świadczenia usługi żądanej przez użytkownika lub zapewnienia
            ...
            <p>
              ...
              Serwisu lub zmianami w sposobie świadczenia jego funkcjonalności.
            </p>
          </section>
          <section id="analytics">
            ...
            <p>
              ...
              wykorzystywane w celu zbierania informacji o sposobie korzystania
              z Serwisu, takich jak liczba odwiedzin, odwiedzane podstrony, czas
              korzystania z poszczególnych funkcjonalności oraz sposób
              poruszania się po Serwisie.
            </p>

            <p>
              <strong>5.2.</strong> Informacje zbierane za pomocą analitycznych
              plików cookies mogą być wykorzystywane do analizowania działania
              Serwisu, wykrywania problemów technicznych oraz poprawy jego
              funkcjonalności, wydajności i użyteczności.
            </p>

            <p>
              <strong>5.3.</strong> Analityczne pliki cookies mogą być
              zapisywane na urządzeniu użytkownika wyłącznie po wyrażeniu przez
              niego odpowiedniej zgody, jeżeli zgoda taka jest wymagana przez
              obowiązujące przepisy prawa.
            </p>

            <p>
              <strong>5.4.</strong> Dane zbierane w ramach analityki mogą być
              przetwarzane w sposób zagregowany lub z wykorzystaniem informacji,
              które nie pozwalają Administratorowi na bezpośrednią identyfikację
              użytkownika, zależnie od zastosowanego rozwiązania
              technologicznego.
            </p>
            ...
            <p>
              ...
              informacje związane z korzystaniem z Serwisu mogą być przekazywane
              tym podmiotom na zasadach określonych w Polityce Prywatności oraz
              zgodnie z obowiązującymi przepisami prawa.
            </p>

            <p>
              <strong>5.6.</strong> Użytkownik może w dowolnym momencie zmienić
              swoje ustawienia dotyczące analitycznych plików cookies za
              pośrednictwem ustawień cookies dostępnych w Serwisie.
            </p>
          </section>
          <section id="functional">
            ...
            <p>
              ...
              preferencji dotyczących korzystania z Serwisu, ustawień interfejsu
              lub innych wyborów dokonanych przez użytkownika.
            </p>
            ...
            <p>
              ...
              ustawienia personalizujące korzystanie z Serwisu nie będą dostępne
              lub nie będą działały w pełnym zakresie.
            </p>

            <p>
              <strong>6.5.</strong> Funkcjonalne pliki cookies nie są
              wykorzystywane do celów marketingowych, chyba że dany plik został
              wyraźnie zaklasyfikowany do kategorii marketingowej i użytkownik
              wyraził na niego odpowiednią zgodę.
            </p>

            <p>
              <strong>6.6.</strong> Użytkownik może w dowolnym momencie zmienić
              swoje ustawienia dotyczące funkcjonalnych plików cookies za
              pośrednictwem ustawień cookies dostępnych w Serwisie.
            </p>
          </section>
          <section id="marketing">
            ...
            <p>
              ...
              Podmioty te mogą przetwarzać informacje związane z korzystaniem z
              Serwisu zgodnie z własnymi zasadami prywatności oraz
              obowiązującymi przepisami prawa.
            </p>
            ...
            <p>
              <strong>7.6.</strong> Użytkownik może odmówić zgody na stosowanie
              marketingowych plików cookies oraz w dowolnym momencie zmienić
              swoje ustawienia za pośrednictwem ustawień cookies dostępnych w
              Serwisie.
            </p>
          </section>
          <section id="thirdParty">
            ...
            <p>
              ...
              cookies przez podmioty trzecie może zależeć od ich własnych usług,
              konfiguracji technicznej oraz zasad ochrony prywatności
              stosowanych przez te podmioty.
            </p>

            <p>
              <strong>8.4.</strong> Jeżeli zastosowanie plików cookies podmiotów
              trzecich wymaga zgody użytkownika, zostaną one uruchomione dopiero
              po wyrażeniu odpowiedniej zgody za pośrednictwem mechanizmu
              zarządzania zgodami dostępnego w Serwisie.
            </p>
            ...
            <p>
              ...
              korzystania z Serwisu lub innych danych związanych z korzystaniem
              z ich usług.
            </p>
          ...
          <section id="consent">
            ...
            <p>
              <strong>9.3.</strong> Pliki cookies analityczne, funkcjonalne oraz
              marketingowe mogą być uruchamiane zgodnie z wyborem dokonanym
              przez użytkownika, jeżeli ich stosowanie wymaga uprzedniej zgody.
            </p>
            ...
            <p>
              ...
              jednak niektóre dodatkowe funkcje mogą być niedostępne lub działać
            ...
            <p>
              <strong>9.6.</strong> Użytkownik może w dowolnym momencie otworzyć
              ustawienia cookies i zmienić wcześniej dokonane wybory. Zmiana
              ustawień nie wpływa na zgodność z prawem przetwarzania dokonanego
              na podstawie wcześniejszej zgody przed jej zmianą.
            </p>
          ...
          <section id="withdraw">
            ...
            <p>
              <strong>10.1.</strong> Użytkownik może w dowolnym momencie zmienić
              swoje preferencje dotyczące opcjonalnych plików cookies za
              pośrednictwem panelu ustawień cookies dostępnego w Serwisie.
            </p>

            <p>
              <strong>10.2.</strong> Użytkownik może wycofać wcześniej udzieloną
              zgodę na stosowanie analitycznych, funkcjonalnych lub
              marketingowych plików cookies, w zakresie, w jakim ich stosowanie
              jest uzależnione od zgody użytkownika.
            </p>
            ...
            <p>
              <strong>10.4.</strong> Po zmianie ustawień Serwis może potrzebować
              chwili na zastosowanie nowych preferencji. W niektórych
              przypadkach może być również konieczne odświeżenie strony lub
              ponowne uruchomienie przeglądarki.
            </p>

            <p>
              <strong>10.5.</strong> Wycofanie zgody na opcjonalne pliki cookies
              nie powoduje wyłączenia cookies niezbędnych do prawidłowego
              działania Serwisu, których stosowanie nie jest uzależnione od
              zgody użytkownika.
            </p>

            <p>
              <strong>10.6.</strong> Zmiana lub wycofanie zgody może spowodować
              ograniczenie dostępności niektórych funkcjonalności Serwisu,
              jeżeli ich działanie zależy od wykorzystania określonych plików
              cookies.
            </p>
          ...
          <section id="browser">
            ...
            <p>
              ...
              różnić się w zależności od używanej przeglądarki oraz jej wersji.
              Szczegółowe informacje dotyczące dostępnych ustawień należy
              sprawdzić w dokumentacji lub ustawieniach używanej przeglądarki.
            </p>

            <p>
              <strong>11.4.</strong> Całkowite zablokowanie lub usunięcie plików
              cookies może spowodować nieprawidłowe działanie niektórych
              funkcjonalności Serwisu, w szczególności funkcji wymagających
              utrzymania sesji lub zapamiętywania określonych ustawień
              użytkownika.
            </p>

            <p>
              <strong>11.5.</strong> Zmiana ustawień przeglądarki nie zastępuje
              ustawień zgód dostępnych w Serwisie w zakresie, w jakim przepisy
              prawa wymagają uzyskania zgody użytkownika na stosowanie
          ...
          <section id="changesAndContact">
            ...
            <p>
              ...
              kategorii, przeznaczenia albo sposobu działania stosowanych plików
              cookies.
            </p>
            ...
            <p>
              <strong>12.6.</strong> W sprawach dotyczących przetwarzania danych
              osobowych w związku z wykorzystywaniem plików cookies zastosowanie
              mają również postanowienia Polityki Prywatności dostępnej w
              Serwisie.
            </p>
          </section>
        </div>
