          ...
          <div className={styles.card}>
            ...
            {step === 1 && (
              <div className={styles.categories}>
                <h2 className={styles.heading}>Kategoria ogłoszenia</h2>
            ...
            {step === 2 && category === "Praca" && (
              <div className={styles.typeSection}>
                <h2 className={styles.heading}>Typ ogłoszenia</h2>
                ...
                <div className={styles.typeDescription}>
                  {hoveredType === "job_offer" && (
                    <p>
                      ...
                      dorywczą, na pół etatu albo zlecić wykonanie konkretnej
                      usługi lub zadania.
                    </p>
                  )}
              ...
              <div className={styles.typeSection}>
                ...
                <div className={styles.typeDescription}>
                  {hoveredType === "housing_offer" && (
                    <p>
                      Dodaj ogłoszenie jeśli wynajmujesz mieszkanie, pokój, dom
                      lub lokal. Możesz dodać zdjęcia, opis i dane kontaktowe.
                    </p>
                  )}

                  {hoveredType === "housing_wanted" && (
                    <p>
                      Dodaj ogłoszenie jeśli szukasz mieszkania, pokoju, domu
                      lub lokalu do wynajęcia. Opisz czego szukasz i dodaj dane
                      kontaktowe.
                    </p>
                  )}
              ...
              <div className={styles.typeSection}>
                ...
                <div className={styles.typeDescription}>
                  {hoveredType === "market_offer" && (
                    <p>
                      Dodaj ogłoszenie jeśli chcesz sprzedać produkt, przedmiot
                      lub rzecz. Możesz dodać opis, stan produktu, zdjęcie i
                      dane kontaktowe.
                    </p>
                  )}
              ...
              <div className={styles.typeSection}>
                ...
                <div className={styles.typeDescription}>
                  {hoveredType === "service_offer" ? (
                    <p>
                      Dodaj ogłoszenie jeśli oferujesz usługę jako osoba
                      prywatna lub firma. Takie ogłoszenia są aktywne
                      bezterminowo i będą widoczne również na profilu firmy.
                    </p>
                  ) : (
                    <p>
            ...
            {step === 3 && (
              <div className={styles.typeSection}>
                <h2 className={styles.heading}>Kto dodaje ogłoszenie?</h2>
                  ...
                  {type === "market_wanted" && (
                    <div>
                      <div className={styles.imageUploader}>
                        <img
                          src={
                            previewImage || "/offersCategories/Marketplace.webp"
                          }
                          alt="Preview"
                          className={styles.imagePreview}
                        />
                  ...
                  {type === "service_offer" && (
                    <div>
                      <div className={styles.imageUploader}>
                        <img
                          src={
                            previewImage || "/offersCategories/Services.webp"
                          }
                          alt="Preview"
                          className={styles.imagePreview}
                        />
                      ...
                      {[7, 14, 31].map((d) => {
                        ...
                        return (
                          <button
                            ...
                            title={
                              isDisabled
                                ? "Wybierz dłuższy czas ogłoszenia"
                                : ""
                            }
                            className={`
          ...
          {step >= 4 && (
            <div className={styles.summaryCard}>
              ...
              <div className={styles.summaryContent}>
                ...
                {formData.isUrgent && <p>Etykieta: Pilne</p>}
